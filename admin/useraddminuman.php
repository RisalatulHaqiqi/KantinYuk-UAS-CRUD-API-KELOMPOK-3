...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <h1><i class="fas fa-plus-circle"></i> Tambah Menu minuman</h1>
            <p class="subtitle">Tambahkan menu minuman baru ke dalam sistem</p>
        </div>
            ...
            <form id="form2" name="form2" method="post" action="" enctype="multipart/form-data">
                <div class="form-row">
                    <div class="form-group">
                        <label for="nama">
                            <i class="fas fa-tag"></i> Nama minuman
                        </label>
                        <input name="nama" type="text" id="nama" placeholder="Masukkan nama minuman..." required />
                    </div>
                ...
                <div class="form-group">
                    <label for="foto">
                        <i class="fas fa-image"></i> Foto minuman
                    </label>
        ...
        <div class="preview-card">
            ...
            <div class="preview-content">
                ...
                <div class="preview-details">
                    <h4 id="previewNama">Nama minuman</h4>
    ...
    <script>
        ...
        document.getElementById('nama').addEventListener('input', function() {
            document.getElementById('previewNama').textContent = this.value || 'Nama minuman';
        });
...
if (isset($_POST["simpan"])) {
    ...
    if ($sqlm_exec) {
        echo "<script>
                alert('Data minuman berhasil disimpan!');
                setTimeout(function() {
